...
The graph looks quite good, but with time series data like this it would be more normal to plot it as a line graph. This is done by changing the "type=" function argument. We can make the line thicker with the "lwd=" argument, and we might want to change the color. 
